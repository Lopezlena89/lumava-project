...
export const Card = ({data}:Props) => {
  ...
  return (
    <>
        <div
        className='flex  flex-col h-[270px] md:min-h-[300px] m-2 items-center justify-start overflow-hidden rounded-xl border border-gray-800 bg-gradient-to-r from-black to-gray-950  '
        >
