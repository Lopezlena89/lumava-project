...
import { HeaderModal } from "../form/HeaderModal";
...
export const Modal = () => {
    const {isSideModal,closeSideModal} = useModalStore((state) => state);
    const {isSideModalPreview} = useModalPreviewStore((state) => state);
