            ...
            <div className="w-full h-auto md:min-h-[750px] grid sm:grid-cols-4 md:grid-cols-6 md:grid-rows-4">
                ...
                <div className="w-full h-[200px] md:h-full p-2  row-span-1 col-span-2 relative order-3 md:order-none">
                  ...
                  <div  className="w-full h-full top-2  flex flex-col  justify-center items-center  rounded-lg   border border-purple-400 ">
                    ...
                    <div className="w-full  h-full  absolute px-5 flex flex-col justify-center rounded-lg  text-[13px] md:text-[10px] lg:text-[13px] ">
                      <p className="text-purple-200 ">1.-Comenzar por comprender la empresa, su industria, su público objetivo y su competencia.</p>
                ...
                <div className="w-full h-[200px] md:h-full p-2 row-span-1 md:row-span-2 col-span-2 relative  order-4 md:order-none">
                  ...
                  <div  className="h-full w-full top-2  flex flex-col  justify-center items-center  rounded-lg   border border-purple-400 ">
                    ...
                    <div className="w-full  h-full absolute px-5 flex flex-col justify-center rounded-lg  text-[13px] md:text-[10px] lg:text-[13px]">
                      <p className="text-purple-200 ">1.-Establecer la misión, visión y valores de la marca.</p>
                      <p className="text-purple-200 ">2.-Definir la personalidad de la marca, incluyendo su tono de voz, estilo y atributos clave.</p>
                      <p className="text-purple-200 ">3.-Desarrollar una propuesta de valor única que diferencie a la marca de la competencia.</p>
                    </div>
                  </div>
                ...
                <div className="w-full h-[300px] md:h-full  px-2 flex justify-center items-center row-span-2 col-span-2 relative order-2 md:order-none">
                    ...
                    <div className="w-full h-[97%] flex flex-col p-5 card items-center justify-center  rounded-lg border border-purple-400">
                        ...
                        >
                            ...
                            <p className="text-center">{`"Dando vida a tu marca en cada detalle"`}</p>
                        </div>
                    </div> 
                ...
                <div className="w-full h-[200px] md:h-full p-2  col-span-2 relative order-9 md:order-none">
                  ...
                  <div  className="w-full h-full  top-2  flex flex-col  justify-center items-center  rounded-lg   border border-purple-400 ">
                    ...
                    <div className="w-full  h-full absolute flex px-5 flex-col justify-center rounded-lg text-[10px] lg:text-[13px] ">
                      <p className="text-purple-200 ">1.-Realizar seguimiento de la recepción de la nueva identidad visual por parte de los clientes y stakeholders.</p>
                      <p className="text-purple-200 ">2.-Recopilar comentarios y métricas clave para evaluar el éxito de la nueva marca.</p>
                      <p className="text-purple-200 ">3.-Realizar ajustes según sea necesario para mejorar y mantener la consistencia de la identidad visual de la marca a lo largo del tiempo.</p>
                    </div>
                  </div>
                ...
                <div className="w-full h-[200px] md:h-full p-2 col-span-2 relative order-5 md:order-none">
                  ...
                  <div  className="w-full h-full top-2  flex flex-col  justify-center items-center  rounded-lg   border border-purple-400 ">
                    ...
                    <div className="w-full  h-full absolute flex px-5 flex-col justify-center rounded-lg text-[13px] md:text-[10px] lg:text-[13px]">
                      <p className="text-purple-200 ">1.-Crear un logotipo que refleje la identidad y los valores de la marca.</p>
                      <p className="text-purple-200 ">2.-Experimentar con diferentes conceptos, colores, tipografías y estilos.</p>
                      <p className="text-purple-200 ">3.-Realizar interacciones basadas en la retroalimentación de los stakeholders.</p>
                    </div>
                  </div>
                ...
                <div className="w-full h-[200px] md:h-full p-2   col-span-2 relative order-8 md:order-none">
                  ...
                  <div  className="w-full h-full top-2  flex flex-col  justify-center items-center  rounded-lg   border border-purple-400 ">
                    ...
                    <div className="w-full  h-full absolute flex flex-col px-5 justify-center  rounded-lg text-[13px] md:text-[10px] lg:text-[13px]">
                      <p className="text-purple-200 ">1.-Aplicar la nueva identidad visual a todos los puntos de contacto de la marca, incluyendo el sitio web, redes sociales, productos y embalajes.</p>
                      <p className="text-purple-200 ">2.-Lanzar la nueva identidad visual con una campaña de comunicación integrada para generar conciencia y compromiso con la marca.</p>
                    </div>
                  </div>
                ...
                <div className="w-full h-[200px] md:h-full p-2 col-span-2 relative order-7 md:order-none">
                  ...
                  <div  className="w-full h-full top-2  flex flex-col  justify-center items-center  rounded-lg   border border-purple-400 ">
                    ...
                    <div className="w-full  h-full absolute flex flex-col px-5 justify-center rounded-lg text-[13px] md:text-[10px] lg:text-[13px]">
                      <p className="text-purple-200 ">1.-Diseñar materiales de marketing, como tarjetas de presentación, papelería, folletos, banners y anuncios, siguiendo las pautas de la identidad visual de la marca.</p>
                      <p className="text-purple-200 ">2.-Desarrollar plantillas para presentaciones, documentos y otros materiales corporativos.</p>
                ...
                <div className="w-full h-[200px] md:h-full p-2 col-span-2 relative order-6 md:order-none">
                  ...
                  <div  className="w-full h-full top-2  flex flex-col  justify-center items-center  rounded-lg border border-purple-400 ">
                    ...
                    <div className="w-full  h-full absolute flex flex-col px-5 justify-center rounded-lg text-[13px] md:text-[10px] lg:text-[13px] ">
                      <p className="text-purple-200 ">1.-Diseñar elementos visuales adicionales, como paletas de colores, tipografías secundarias, patrones y gráficos complementarios.</p>
                      <p className="text-purple-200 ">2.-Crear una guía de estilo de marca que establezca pautas para el uso consistente de la identidad visual en todos los materiales de la marca.</p>
